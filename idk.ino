...
void robotTurnLeft()
{
 motor1.setSpeed(75);    // Motor 1 runs forward.
 motor2.setSpeed(75);   // Motor 2 runs backward.
}


void robotTurnRight()
{
 motor1.setSpeed(-75);   // Motor 1 runs backward.
 motor2.setSpeed(-75);    // Motor 2 runs forkward.
}
void setup()
{
